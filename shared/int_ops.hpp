...
#define BIGENDIAN16(x) shared::intops::swapendian16(x)
#define BIGENDIAN32(x) shared::intops::swapendian32(x)
#define BIGENDIAN64(x) shared::intops::swapendian64(x)
...
#define LITTLEENDIAN16(x) shared::intops::swapendian16(x)
#define LITTLEENDIAN32(x) shared::intops::swapendian32(x)
#define LITTLEENDIAN64(x) shared::intops::swapendian64(x)
#endif
